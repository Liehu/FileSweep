...
func DefaultOfflineEntries() []OfflineEntry {
	return []OfflineEntry{
		{"nmap", "开源网络扫描与安全审计工具", "https://nmap.org", "https://nmap.org/download.html", "7.95", "GPLv2", "网络安全-扫描器", []string{"network", "security", "scanner"}},
		{"python", "通用编程语言与解释器", "https://python.org", "https://python.org/downloads/", "3.13", "PSF", "开发工具", []string{"language", "programming", "scripting"}},
		{"wireshark", "网络协议分析工具", "https://wireshark.org", "https://wireshark.org/download.html", "4.2", "GPLv2", "网络安全-扫描器", []string{"network", "analyzer", "capture"}},
		{"node", "JavaScript 运行时环境", "https://nodejs.org", "https://nodejs.org/en/download/", "22.0", "MIT", "开发工具", []string{"runtime", "javascript", "server"}},
		{"git", "分布式版本控制系统", "https://git-scm.com", "https://git-scm.com/downloads", "2.45", "GPLv2", "开发工具", []string{"vcs", "scm", "devtools"}},
		{"vscode", "轻量级代码编辑器", "https://code.visualstudio.com", "https://code.visualstudio.com/Download", "1.89", "MIT", "开发工具", []string{"editor", "ide", "microsoft"}},
		{"vlc", "跨平台多媒体播放器", "https://videolan.org/vlc", "https://videolan.org/vlc/", "3.0.21", "GPLv2", "多媒体", []string{"media", "player", "video"}},
		{"7zip", "高压缩比文件压缩工具", "https://7-zip.org", "https://7-zip.org/download.html", "24.03", "LGPL", "办公文档", []string{"archive", "compression", "utility"}},
		{"putty", "SSH/Telnet 远程连接工具", "https://putty.org", "https://putty.org", "0.81", "MIT", "开发工具", []string{"ssh", "terminal", "remote"}},
		{"curl", "命令行 HTTP 客户端", "https://curl.se", "https://curl.se/download.html", "8.7", "MIT", "开发工具", []string{"http", "cli", "transfer"}},
		{"hutool", "Java 工具类库", "https://hutool.cn", "https://hutool.cn/docs/#/hutool", "5.8.25", "MIT", "开发工具", []string{"java", "utility", "library"}},
		{"docker", "容器化平台", "https://docker.com", "https://docker.com/products/docker-desktop/", "26.0", "Apache-2.0", "开发工具", []string{"container", "devops", "virtualization"}},
		{"go", "Go 编程语言", "https://go.dev", "https://go.dev/dl/", "1.23", "BSD-3", "开发工具", []string{"language", "programming", "google"}},
		{"rust", "Rust 编程语言", "https://rust-lang.org", "https://rust-lang.org/tools/install", "1.78", "MIT", "开发工具", []string{"language", "programming", "systems"}},
		{"ffmpeg", "音视频处理工具", "https://ffmpeg.org", "https://ffmpeg.org/download.html", "7.0", "LGPL", "多媒体", []string{"media", "video", "audio"}},
	}
}
